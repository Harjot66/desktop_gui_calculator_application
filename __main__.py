#importing tkinter, creating root widget, creating title

from tkinter import *
root = Tk()
root.title("Calculator")

#creating an input text box and putting it on screen

e = Entry(root, width = 35, borderwidth = 5)
e.grid(row = 0, column = 0, columnspan = 3, padx = 10, pady = 10)

#defining functions for calculator button commands
